...
export function DegreePlannerPage() {
  ...
  return (
    <>
      <header className="acorn-header">
        <div className="acorn-header-top">
          <span className="acorn-crest" aria-hidden="true">
            🎓
          </span>
          <span className="acorn-header-divider" />
          <h1>Degree Planner</h1>
        </div>
        <nav className="acorn-header-nav">
